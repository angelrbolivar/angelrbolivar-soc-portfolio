...
All three rules produced incidents from the live attack traffic the honeypot attracted — no simulated events were injected.

![Sentinel incidents queue — incidents generated by the honeypot rules](screenshots/incidents-queue.png)
